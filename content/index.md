...
При создании персонажа вы можете воспользоваться правилами из [основной книги](./Книги/corebook.pdf), [руководства игрока](./Книги/players.pdf) и книгах [Анархи](./Книги/anarch.pdf) и [Инквизиция](./Книги/inquisition.pdf). Настоятельно рекомендую использовать [[index#Страницы истории|Страницы истории]] из этого раздела, а не из перечисленных книг.
